...
function del(){
	...
	if(mes==true){ 
		window.location.href='${basePath}/jobConfigController/'+id+'/del.do';
	}
}
</script>
  ...
  <div id="accordion" class="ui-accordion ui-widget ui-helper-reset" role="tablist">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="ui-datalist-view" style="margin-top:5px;">
      ...
      <tr onmouseover="this.className='ui-state-highlight'" onmouseout="this.className=''">
        <td ><input type="radio" name="radio" id="radio" value="${s.id}" /></td>
        <td>${s.jobId}</td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="ui-function-box ui-pager">
      <tr>
        <td class="ui-btn-area"><div >
            ...
            <input type="button" value="删除" class="ui-btn ui-btn-delete" onmouseover="this.className='ui-btn ui-btn-delete-hover'" onmouseout="this.className='ui-btn ui-btn-delete'" onclick="del()"/>
          </div></td>
      </tr>
    </table>
    <!--*************************数据列表操作区*************************-->
