...
public class CheckIdCard {
    ...
    private static CheckIdCard checkIdcard = new CheckIdCard();
    private CheckIdCard(){
    	
    }
    
    public static CheckIdCard getInstance(String cardNumber) {
    	 if (null != cardNumber) {
    	 ...
    	 CheckIdCard.cardNumber = cardNumber;
    	if(checkIdcard == null) {
...
//        System.out.println(new CheckIdCard("23082819790311004X").validate());
//    }
}
