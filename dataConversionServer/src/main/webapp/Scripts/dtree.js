...
| Tree 2.05 | www.destroydrop.com/javascript/tree/ |
...
function Tree(objName) {
	...
	this.icon = {
		...
		root				: 'GlobalStyle/images/ui-icon_base.gif',

		folder			: 'GlobalStyle/images/ui-icon_folder.gif',

		folderOpen	: 'GlobalStyle/images/ui-icon_folderopen.gif',

		node				: 'GlobalStyle/images/ui-icon_page.gif',

		empty				: 'GlobalStyle/images/ui-icon_empty.gif',

		line				: 'GlobalStyle/images/ui-icon_line.gif',

		join				: 'GlobalStyle/images/ui-icon_join.gif',

		joinBottom	: 'GlobalStyle/images/ui-icon_joinbottom.gif',

		plus				: 'GlobalStyle/images/ui-icon_plus.gif',

		plusBottom	: 'GlobalStyle/images/ui-icon_plusbottom.gif',

		minus				: 'GlobalStyle/images/ui-icon_minus.gif',

		minusBottom	: 'GlobalStyle/images/ui-icon_minusbottom.gif',

		nlPlus			: 'GlobalStyle/images/ui-icon_nolines_plus.gif',

		nlMinus			: 'GlobalStyle/images/ui-icon_nolines_minus.gif'
