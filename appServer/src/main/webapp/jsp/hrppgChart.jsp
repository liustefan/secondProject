<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
	...
	<head>
		...
		.loading-indicator {
	font-size: 8pt;
	background-image: url(<%=request.getContextPath()%>/img/loading.gif);
...
#loading {
	...
	background: white url(<%=request.getContextPath()%>/img/block-bg.gif) repeat-x;
	padding: 10px;
...
#msg {
	...
	<div id="loading">
		...
		<div id="instantSphygmusChart" style="margin: 0 auto;"></div>
	</body>
<script type="text/javascript">
	...
	$(function(){
		...
		if(dt != null){
			var json = eval("("+dt+")"); 
			setChart("instantSphygmusChart", json);
		}else{
			$('#msg').show();
		}
	});
