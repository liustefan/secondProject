...
public class Constants {
    ...
    /* 资料合并-直接合并*/
    public static final int  MERGE_DIRECT = 9999;
    
    /* 资料合并-可以合并*/
    public static final int  MERGE_MAY = 8888;
    
    /* 资料合并-简码相同，需要确定*/
    public static final int  MERGE_NEED_CONFIRM = 6666;
    
    /* 资料合并-找客服联系*/
    public static final int  MERGE_SERVICE_CONTACT = 7777;
    
    /* 资料合并-待同步*/
    public static final byte  MERGE_SYNC_STATUS = 1;
    
    /* 资料合并-模块类型--测量*/
    public static final byte  MERGE_MODULETYPE_MEASURE = 1;
    
    /* 资料合并-模块类型--朋友圈*/
    public static final byte  MERGE_MODULETYPE_FRIEND = 2;
    
    /* 资料合并-模块类型--问卷*/
    public static final byte  MERGE_MODULETYPE_PAPER = 3;
    
    /* 广告使用范围--健康服务套餐--问卷*/
    public static final byte  AD_USEPAGE_HEALTH = 4;
