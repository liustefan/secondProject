...
<body>
<div class="content">
     <form action="chooseHealthTemp" method="POST" id="pojo">
		...
		<div class="table-box">
			<c:if test="${page.totalCount == 0}">
	  			<div class="empty-info border-1-solid align-center">目前还没有健教信息</div>
	  		</c:if>
			<c:if test="${page.totalCount > 0}">
			<table class="table-content">
				...
				<c:forEach items="${page.result}" var="health">
					<tr>
						...
						<td>
							<a href="javascript: void(0);" onclick="parent.setHed(${health.heducationid}, '<c:out value='${health.title}' escapeXml='true'/>')">选择</a>
						</td>
					</tr>
				</c:forEach>
				</tbody>
