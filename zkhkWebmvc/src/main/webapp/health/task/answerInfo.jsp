...
<head>
	...
	<script type="text/javascript" src="<%=path %>/js/taskQuestion.js"></script>
	<script type="text/javascript">
		var omfq = ${omfq};
		var ansNumber = '${ansNumber}';
		var combQustId = '${combAnsId}';
		var uai21 = ${uai21};
		var memberId  = '${pojo.memberid}';
		var MSETaskID = '${pojo.MSETaskID}';
		var href = "answerQuestion";
...
<div class="content">
	<div class="content-title">作答单份答卷</div>
