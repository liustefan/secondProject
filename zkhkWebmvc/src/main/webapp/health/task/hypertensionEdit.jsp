...
function setBaseInfo(obj){
	if(obj.memberId){
		...
		setOtherInfo(obj.memberId, 'h', '../../inspect/hypertension/getLatestInfoByMemberId');
	}
}
...
$(function() {
	init();
	setBaseInfo({memberId: '${empty pojo.hypertensionID ? pojo.memberID : ''}'});
	
	if($("#follow_type").val() == 2){
		$("input[name='phHypertensiondetail.visitWay'][value='3']").prop('disabled', true);
		if($("input[name='hypertensionID']").val() == ''){
			$("input[name='phHypertensiondetail.visitWay'][value='1']").prop('checked', true);
		}
	}else if($("#follow_type").val() == 1){
		$("input[name='phHypertensiondetail.visitWay'][value='1']").prop('disabled', true);
		$("input[name='phHypertensiondetail.visitWay'][value='2']").prop('disabled', true);
		$("input[name='phHypertensiondetail.visitWay'][value='3']").prop('checked', true);
	}
...
<body>
	<div class="content">
		<div class="border-green">
			...
			<div class="table-box">
				<form id="forms" action="hypertension?source=${param.source}" method="post">
