...
function getJson() {
    var url = "../bloodSugar/getBloodSugarChart";
...
function exportWord() {
    ...
    var url = "../bloodSugar/getReportSVGData";
    $.ajax({
        url: url,
        type: "post",
        data: {
        ...
        success: function(data) {
        	if(data == "1"){
            window.location = "../bloodSugar/exportReportWord?obsrsJson=" + JSON.stringify(obsrsJson) + "&memberId="+memberid+"&generTime="+$("#generTime").val();
        	}
        }
    });
}
