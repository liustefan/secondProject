...
<head>
    ...
    <script type="text/javascript" src="<%=path %>/js/elderlyHealthManagement.js"></script>
</head>
...
<div class="content">
	...
	<div class="content-title">老年人接受健康管理状况</div>
    ...
    <div class="info-charts">
        <!-- 老年人接受健康管理状况 -->
        <div id="chart-healthManage" style="min-width:700px; margin: 15px auto; "></div>
    </div>
    <%--组织名称分组--%>
