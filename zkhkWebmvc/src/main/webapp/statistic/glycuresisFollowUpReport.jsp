...
<head>
    ...
    <script type="text/javascript" src="<%=path %>/js/glycuresisFollowUpReport.js"></script>
</head>
...
<div class="content">
	...
	<div class="content-title">糖尿病随访</div>
    ...
    <div class="info-charts">
        <!-- 糖尿病随访状况表 -->
        <div id="chart-glycureis1" style=" min-width: 700px; margin: 15px auto; "></div>
        <!-- 各地区糖尿病随访状况横向对比表 -->
        <div id="chart-glycureis2" style=" min-width: 700px; margin: 15px auto;"></div>
    </div>
    <%--组织名称分组--%>
