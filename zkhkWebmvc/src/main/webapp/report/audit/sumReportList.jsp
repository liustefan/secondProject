	...
	<script type="text/javascript">
		...
		//置灰效果
			...
			$("#lines").change(function(){
				var lines=$("#lines").val();
				window.location = "${pageContext.request.contextPath}/summaryReport/showSumReportList?funId=2&pageSize="+lines;
			});
			...
			$("#toPage-btn").click(function(){
				...
				var topage= $("#toPage");
				topage.val(pageNow);
				window.location = "${pageContext.request.contextPath}/summaryReport/showSumReportList?funId=2&pageNo="+num+"&pageSize="+lines;
			});
			//禁用分页回车键
			...
			$("#page-first").click(function(){
				...
				window.location = "${pageContext.request.contextPath}/summaryReport/showSumReportList?funId=2&pageNo=1&pageSize="+lines;
			});
			$("#pre").click(function(){
			    var lines=$("#lines").val();
				var pageNum= "${page.pageNo}";
				...
				window.location = "${pageContext.request.contextPath}/summaryReport/showSumReportList?funId=2&pageNo=${page.pageNo-1}&pageSize="+lines;
			}); 
			$("#nex").click(function(){
			    var lines=$("#lines").val();
				var pageNum= "${page.pageNo}";
			...
			$("#page-last").click(function(){
				...
				window.location = "${pageContext.request.contextPath}/summaryReport/showSumReportList?funId=2&pageNo=${page.totalPages}&pageSize="+lines;
			}); 
		});
	</script>
</head>
<body>
	<div class="content">
		<div class="content-title">汇总测量数据</div>
					  ...
					  <thead class="table-title">
						...
						<c:forEach var="item" items="${page.result}" varStatus="status">
							<tr>
								...
								<td>${item.memName}</td>
							   	<td>
							   	 	<fm:formatDate value="${item.startTime}" type="date" pattern="yyy-MM-dd HH:mm:ss" dateStyle="long"/>-
							   		<fm:formatDate value="${item.grenerTime}" type="date" pattern="yyy-MM-dd HH:mm:ss" dateStyle="long"/>
							   	</td>
				               	...
				               	<td id="table_content_title_td">
									<a href="../summaryReport/toReportAuditPage?isAudit=N&auditLevel=${item.auditLevel}&reportNo=${item.ID}">查看</a>
				               	</td>
				             </tr>
				            </c:forEach>  
				           </tbody>
