...
<div class="content">
	...
	<div class="new-temp-box">
		<form id="fm_template" action="<%=request.getContextPath()%>/template/addOpinionTemplate?"   method="post" onsubmit="return checkName()  &&  checkContent() && confirm('确认保存？');"> 
			<div class="title-temp">
		         <div class="fl"><span>模板名称：</span><input type="text" id="name"  name="name" class="temp-name"/><span id="name_msg" style="color:red; display: none;"> *长度应该为1~50个字符！</span></div>
		         <div class="fr">
			         <span>模板类型：</span>
			         <select name="type">
