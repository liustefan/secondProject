	...
	<script type="text/javascript">
		...
		$(function(){
	        ...
	        $("#pageSize").change(function(){
				  ...
				  window.location = "../electrocardioPulse/showAllElectrocardioPulse?memberId=${omem.memberid }&pageSize="+pageSize+"&startTime=${startTime}&endTime=${endTime}&eventId=${eventId}&flag=${flag}";
			  }); 
			...
			$("#page-first").click(function(){
				...
				window.location = "../electrocardioPulse/showAllElectrocardioPulse?memberId=${omem.memberid }&pageNo=1&startTime=${startTime}&endTime=${endTime}&eventId=${eventId}&pageSize="+pageSize+"&flag=${flag}";
	     	}); 
			...
			$("#page-last").click(function(){
				...
				window.location = "../electrocardioPulse/showAllElectrocardioPulse?memberId=${omem.memberid }&pageNo=${page.totalPages}&startTime=${startTime}&endTime=${endTime}&eventId=${eventId}&pageSize="+pageSize+"&flag=${flag}";
	      	});
			 ...
			 $("#pre").click(function(){
				...
				window.location = "../electrocardioPulse/showAllElectrocardioPulse?memberId=${omem.memberid }&pageNo=${page.pageNo-1}&startTime=${startTime}&endTime=${endTime}&eventId=${eventId}&pageSize="+pageSize+"&flag=${flag}";
	      	}); 
			 ...
			 $("#toPage-btn").click(function(){
					...
					var topage= $("#toPage");
					topage.val(pageNow);
					window.location = "../electrocardioPulse/showAllElectrocardioPulse?memberId=${omem.memberid }&pageNo="+num+"&startTime=${startTime}&endTime=${endTime}&pageSize="+pageSize+"&flag=${flag}";
			  });
		...
		function toResearch(memberId){
			...
			window.location = "../electrocardioPulse/showAllElectrocardioPulse?startTime="+startTime+"&endTime="+endTime+"&memberId="+memberId+"&eventId=${eventId}&flag=${flag}";
		}
		...
		function genReport(){
			post("../electrocardioPulse/getReportSHYDetail",{oecgsJson:JSON.stringify(${oecgJsonArr}),oppgsJson:JSON.stringify(${oppgJsonArr}),memberid:${omem.memberid}});
		}
	</script>
</head>
<body>
  		...
  		<div id="footer_content">
	 		<c:if test="${not empty page.result}">	
				...
				<table id="footer_content1_table">
					<tr align="center" bgcolor="#BCDEE0">
						<th>序号</th>
						<th>测量时间</th>
						<th width="10%">平均心率</th>
						<th width="30%">分析结果</th>
						...
						<tr align="center">
							...
							<td>
								<c:forEach items="${requestScope.map }" var="map">
									<c:if test="${map.key == oecg.eventid }">
									<c:choose>
							...
							<td  id="footer_content1_table_td_a">
					    		 <label id="label_select">
							    	<a href="../electrocardioPulse/showSingleElectroPulse?memberId=${omem.memberid }&docentry=${oecg.docentry}&flag=${flag}&view=1">查看</a>
							    </label>
