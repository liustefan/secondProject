/*
 * PhHypertensiondetailmedicine.java
 ...
 */
public class PhHypertensiondetailmedicine extends GenericModel {

    /**
	 * serialVersionUID:TODO(用一句话描述这个变量表示什么). 
	 */
	private static final long serialVersionUID = -757732873663492522L;
	/**
     * 记录ID
     */
    private Long logID;
    /**
     * 糖尿病随访主ID，引用ph_hypertension
     */
