...
public class PhHypertensionExample {

    protected String orderByClause;
    protected boolean distinct;
    protected List<Criteria> oredCriteria;
    protected Page<PhHypertension> page;
    
    public PhHypertensionExample() {
    ...
    public Page<PhHypertension> getPage() {
		return page;
	}
	public void setPage(Page<PhHypertension> page) {
		this.page = page;
	}
