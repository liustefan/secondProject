 ...
 */
public class PhHypertension extends DictEntity {

    /**
	 * serialVersionUID:TODO(用一句话描述这个变量表示什么). 
	 */
	private static final long serialVersionUID = -8715696780813949768L;
	/**
     * 高血压随访主ID
     */
    ...
    private PhHypertensiondetail phHypertensiondetail;
    private List<PhHypertensiondetailmedicine> phHypertensiondetailmedicines;
	...
	public PhHypertensiondetail getPhHypertensiondetail() {
		return phHypertensiondetail;
	}
	public void setPhHypertensiondetail(PhHypertensiondetail phHypertensiondetail) {
		this.phHypertensiondetail = phHypertensiondetail;
	}
	public List<PhHypertensiondetailmedicine> getPhHypertensiondetailmedicines() {
		return phHypertensiondetailmedicines;
	}
	public void setPhHypertensiondetailmedicines(
			List<PhHypertensiondetailmedicine> phHypertensiondetailmedicines) {
		this.phHypertensiondetailmedicines = phHypertensiondetailmedicines;
	}
	...
	public String getVisitClassStr(){
		return convertStr("此次随访分类", "高血压随访", visitClass);
	}
	/**
	 * mSETaskID.
	 *
