/*
 * PhHealthexamdetailinpatientMapper.java
...
public interface PhHealthexamdetailinpatientMapper extends GenericBaseDao<PhHealthexamdetailinpatient, PhHealthexamdetailinpatientExample, Long> {
}