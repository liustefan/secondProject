/*
 * PhHealthexamdetailinpatient.java
 ...
 */
public class PhHealthexamdetailinpatient extends GenericModel {

    /**
	 * serialVersionUID:TODO(用一句话描述这个变量表示什么). 
	 */
	private static final long serialVersionUID = -4312012273480413416L;
	/**
     * 记录ID
     */
    private Long logID;
