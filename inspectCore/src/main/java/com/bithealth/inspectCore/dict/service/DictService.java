...
 * @FileName:     PhDictService.java  
 * @Description: TODO(用一句话描述该文件做什么)  
 * Copyright:    Copyright(C) 2016-2026 
 * 公司:          深圳中科汇康技术有限公司 
 * @author:      名字  * 
 * @version      V1.0  
 * @Createdate:  2016年6月28日 上午11:29:04  
 * 
 */

package com.bithealth.inspectCore.dict.service;
...
public interface DictService {
	 ...
	 */
	Map<String, List<PhDictitem>> selectAllSecond_cache();
