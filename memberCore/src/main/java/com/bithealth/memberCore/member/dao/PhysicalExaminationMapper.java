/*
 * PhysicalExaminationMapper.java
...
public interface PhysicalExaminationMapper extends GenericBaseDao<PhysicalExamination, PhysicalExaminationExample, Integer> {
}